...
export const ar: Translations = {
  ...
  trusted: {
    heading: 'مُصمَّم للشركات في جميع أنحاء المغرب',
    stat1Value: 'يومي',
    stat1Label: 'تحديثات تلقائية',
    stat1Desc: 'مناقصات جديدة تُضاف باستمرار',
    stat2Value: 'فوري',
  ...
  features: {
    tag: 'كل ما تحتاجه',
    heading1: 'مصمّم',
    headingHighlight: 'للمحترفين الجادّين',
    description: 'كل ميزة مصمّمة لمنحك أفضلية تنافسية — من الاكتشاف إلى تقديم العروض.',
    f1Title: 'البحث الذكي',
    ...
    f7Desc: 'إشعارات فورية للمناقصات الجديدة المطابقة، وتنبيهات المواعيد، والتغييرات في الحالة — في الوقت الفعلي.',
  ...
  pricing: {
    ...
    freeName: 'مجاني',
    freeDesc: 'مثالي للبدء في اكتشاف المناقصات مجاناً.',
    freeCta: 'ابدأ مجاناً',
    premiumName: 'بريميوم',
  ...
  download: {
    ...
    headingHighlight: 'للفوز بمزيد من المناقصات؟',
    description:
  ...
  pages: {
    ...
    pricingDesc: 'ابدأ مجاناً. طوّر عندما تحتاج القوة الكاملة. ألغِ اشتراكك في أي وقت بدون أسئلة.',
