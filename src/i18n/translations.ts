...
export const en: Translations = {
  ...
  faq: {
    ...
    a7: 'Premium costs 149 MAD/month. It unlocks unlimited saved tenders, detailed tender summaries, requirements analysis, instant push notifications, personalized recommendations, advanced filters, multi-language support, and priority customer support.',
...
export const fr: Translations = {
  ...
  faq: {
    ...
    a7: "Le Premium coûte 149 MAD/mois. Il donne accès aux appels d\'offres sauvegardés illimités, aux synthèses détaillées, à l\'analyse des prérequis, aux notifications push instantanées, aux recommandations personnalisées, aux filtres avancés, au support multilingue et au support client prioritaire.",
...
export const ar: Translations = {
  ...
  faq: {
    ...
    q7: 'كم يكلف بريميوم؟',
    a7: 'يكلف بريميوم 149 درهم/شهر. يُلغي القيود على المناقصات المحفوظة، ويوفر ملخصات مفصّلة، وتحليلاً للمتطلبات، وإشعارات push فورية، وتوصيات مخصصة، وفلاتر متقدمة، ودعماً متعدد اللغات، ودعم عملاء ذا أولوية.',
