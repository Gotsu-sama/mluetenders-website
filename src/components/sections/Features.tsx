      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={visible ? 'in-view' : ''}>
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p
              className="fade-up text-lg text-slate-600 dark:text-slate-400 leading-relaxed"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((feature, i) => {
              ...
              return (
                <div
                  key={i}
                  className="fade-up group relative p-6 rounded-2xl border bg-white dark:bg-white/[0.03] border-slate-200 dark:border-white/[0.07] hover:border-[#5CA3E0]/30 dark:hover:border-[#5CA3E0]/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-[#5CA3E0]/5 cursor-pointer"
